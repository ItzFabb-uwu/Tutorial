...
class Main extends PluginBase implements Listener {
	...
	public function onCommand(Commandsender $sender, Command $command, string $label, array $args) : bool{
        $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
          if($sender->hasPermission("tutorial.command")){
          if($command->getName() === "tutorial"){
            $name = $sender->getName();
	...
	public function tutorial($sender)
	{
	    $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
	    
	    $titlerewardsconfig = $config->get("title-tutorial");
	    $titlerewards = str_replace(["&", "+n",], ["§", "\n"], $titlerewardsconfig);
	    $this->menu->readonly();
	    $this->menu->setListener([$this, "tutorialmenu"]);
	...
	public function tutorialmenu(Player $sender, Item $item)
	{
	   $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
